            ...
            <div className="flex flex-col md:flex-row">
              <div className="w-full md:w-1/2 text-[#134A55] flex flex-col gap-5 h-auto md:h-[380px] p-8 md:p-16 border-b md:border-r md:border-b-0">
                ...
                <p className="leading-7 md:leading-8 text-sm md:text-base">
                  ...
                  understand your goals, target audience and market. We conduct
                  extensive research and analysis to identify opportunities and
                  challenges. This phase lays the foundation for a successful
                  design project.
                </p>
              </div>
              <div className="w-full md:w-1/2 text-[#134A55] flex flex-col gap-5 h-auto md:h-[380px] p-8 md:p-16 border-b">
                ...
                <p className="leading-7 md:leading-8 text-sm md:text-base">
                  Based on our findings, we develop creative concepts that align
                  with your brand and objectives. We explore various design
                  directions and present you with innovative ideas that will set
            ...
            <div className="flex flex-col md:flex-row">
              <div className="w-full md:w-1/2 text-[#134A55] flex flex-col gap-5 h-auto md:h-[380px] p-8 md:p-16 border-b md:border-b-0">
                ...
                <p className="leading-7 md:leading-8 text-sm md:text-base">
                  ...
                  visually stunning and functional designs. We pay attention to
                  every detail to ensure a cohesive and impactful result.
                </p>
              </div>
