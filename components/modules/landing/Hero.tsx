...
export function Hero() {
  ...
  return (
    <motion.div
      ...
      className="relative h-[500px]  md:h-[600px] 2xl:h-[850px] flex-col  flex items-center justify-center">
    ...
    <Image src={'/tree2.png'} alt={"sa"} width={600} height={400} className="absolute rotate-180  -right-40 -top-8" />
      ...
      <motion.div
        ...
        <motion.h1
          ...
          className="text-xl md:text-4xl text-white lg:text-5xl tracking-widest leading-relaxed font-bold mb-6"
        >
        ...
        <div className="flex flex-wrap gap-4">
          ...
          >
            <span className="flex text-deepGreen hover:text-white justify-center items-center">
              ...
              <Link className="relative text-lg" href="/estimate">
                Read more
              </Link>
            </span>
          </Button>
